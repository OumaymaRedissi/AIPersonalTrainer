...
def feedback_generator(squat_class,llm):
    ...
    2. Bad Inner Thigh: The knees collapse inward during the squat.
    3. Bad Toe: The weight shifts to the toes instead of being balanced on the whole foot.
    4. Bad Shallow: The squat depth is insufficient, not going low enough.
    5. Bad Back Round: The back is rounded instead of maintaining a neutral spine.
    6. Bad Back Warp: The back excessively arches or hyperextends during the squat.
    7. Bad Head: The head is misaligned, either looking up excessively or looking down.
