...
def feedback_generator(squat_class,llm):
    ...
    template = """Prompt: You are an AI trainer analyzing squats. Your task is to provide feedback on the 
    incorrectness of a squat and suggest corrections. The possible incorrectness categories are:
    
    1. Good: The squat technique is correct.
    2. Bad Head: The head is misaligned, either looking up excessively or looking down.
    3. Bad Back Warp: The back excessively arches or hyper extends during the squat.
    ...
    Given an input describing the incorrectness category, your AI should provide feedback and suggest corrections to 
    improve the squat technique.

    Example Input: "Bad Inner Thigh"

    Example Output: Stand with your feet slightly wider than shoulder-width apart and point your toes slightly 
    outwards to ensure better alignment during the squat. 
